		...
		<!---banner--->
			...
			<div class="agent-section">
				<div class="container">	
					...
					<h1><b><center>Update stock</center></b></h1>
			
			<div class="contact-me" >
			<form action="upstkdb.php" method="post" enctype="multipart/form-data">
			...
			<td width="600" height="50"><center><input type="text" name="nm"id="name"style="width:500px;background-color:white"onblur="javascript:valadd(this.value)"></center></td>
			</tr>
			<tr>
			<th width="600" height="50"><h3><center><b>STOCK ID</b></center></h3></th>
			<td width="600" height="50"><center><input type="text" name="sid"id="ph"style="width:500px;background-color:white"onblur="javascript:valphno(this.value)"></center></td>
			</tr>
			
			<tr>
			<th width="600" height="50"><h3><center><b>ADD QUANTITY<b></center></h3></th>
			<td width="600" height="50"><center><input type="text" name="qn"id="qn" maxlength="5"style="width:500px;background-color:white"onblur="javascript:valq(this.value)"></center></td>
			</tr>
...
{
alert("Stock ID should be only numeric value");
//window.location="ss.php";
...
if(!pattern.test(phno))
{
alert("Quantity should be only numeric value");
//window.location="ss.php";
