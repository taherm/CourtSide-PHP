		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/pools/thghhj.jpg">
									<div class="thumb-image"> <img src="images/pools/thghhj.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/pools/thghhj1.jpg">
									 <div class="thumb-image"> <img src="images/pools/thghhj1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>80</span> ft length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>30</span> ft width</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>12</span> ft depth</h5>
							</div>
							<div class="col-md-2 properties-detail">
						...
						<p>This is a Indoor pool.It ranges from 3 feet to 12 feet.It is situated at Sivajinagar Bangalore..It cost 200 per hour.It was started in the year 2012.</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="KSA" style="display:none">
								<input type="text" name="txt4" value="200" style="display:none">
								</form>
								<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.autohuren.world/">auto huren</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(12.975279258488873,77.67504389628903),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(12.975279258488873,77.67504389628903)});infowindow = new google.maps.InfoWindow({content:'<strong>KSA</strong><br>sivajinagar,bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
