...
<body>
		...
		<!---banner--->
			...
			<div class="content">
						...
						<tr>
						<th><h3><center><b>Product Id</b><center></h3></th>
						<th><h3><center><b>Product Name</b><center></h3></th>
						<th><h3><center><b>Available Stock</b><center></h3></th>
						...
						<?php
								...
								$res=$conn->query($sql);
									...
									{
								echo"<tr><h3><center><td>".$row['proid']."</td></center></h3><h3><center><td>".$row['proname']."</td></center></h3><h3><center><td>".$row['stock']."</td></center></h3><h3><center><td>".$row['price']."</td></center></h3></tr>";
									}
								}
									else{
