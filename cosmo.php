		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/tennis/bpt.jpg">
									<div class="thumb-image"><img src="images/tennis/bpt.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/tennis/bpt1.jpg">
									 <div class="thumb-image"><img src="images/tennis/bpt1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>74</span> ft length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>36</span> ft width</h5>
							</div>
							<div class="col-md-2 properties-detail">
						...
						<p>This is a turf tennis court located at Kamanahalli Bangalore.It has a well maintained european artificial turf....It cost 500 per hour.It was started in the year 2010.</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Cosmopoletine" style="display:none">
								<input type="text" name="txt4" value="500" style="display:none">
								</form>
							</div>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.autohuren.world/">auto huren</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.0159044,77.63786189999996),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.0159044,77.63786189999996)});infowindow = new google.maps.InfoWindow({content:'<strong>Cosmopoletine</strong><br>kamanahalli,banglore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
