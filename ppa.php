...
<ul class="nav navbar-nav">
		...
		<!---banner--->
			...
			<div class="container">
				...
				<h2><b>Prakash padukone Acedamy</b></h2>
				</div>
		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/badminton/badminton2_(1).jpg">
									<div class="thumb-image"> <img src="images/badminton/badminton2_(1).jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/badminton/badminton2_(1)1.jpg">
									 <div class="thumb-image"> <img src="images/badminton/badminton2_(1)1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a Synthetic court.It is well maintained .It is situated at Dumlur Bangalore..It cost 600 per hour.It was started in the year 2012. </p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Prakash padukone Acedamy" style="display:none">
