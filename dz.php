		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/basketball/basketball-courts.jpg">
									<div class="thumb-image"><img src="images/basketball/basketball-courts.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/basketball/basketball-courts1.jpg">
									 <div class="thumb-image"><img src="images/basketball/basketball-courts1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a Indoor Basketball court.It is well maintained with wooden surface.It is situated at Kormagla Bangalore.It has a well maintained wooden surface..It cost 1000 per hour.It was started in the year 2010.The owner of the soccer city is Karthik Naidu </p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="DribbleZone" style="display:none">
