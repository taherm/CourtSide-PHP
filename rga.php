		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/tennis/clay.jpg">
									<div class="thumb-image"><img src="images/tennis/clay.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/tennis/clay1.jpg">
									 <div class="thumb-image"><img src="images/tennis/clay1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>75</span> ft length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>35</span> ft width</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>3</span>ft nets</h5>
							</div>
							<div class="col-md-2 properties-detail">
						...
						<p>This is a clay court with well maintained surface.It is located at Airport road Bangalore...It cost 500 per hour.It was started in the year 2010.</p>
					
							<div class="contact-me">
							<h4>Book Court</h4>
							<form method="post" action="tendb.php">
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Rogers Arena" style="display:none"><br/><br><br>
								<input type="text" name="txt4" value="500" style="display:none"><br/><br><br><br>
								</form>
							<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<form method="post" action="tencan.php">
						...
						<input type="text" name="txt0" value="Rogers Arena" style="display:none"><br/><br><br>
						<input type="text" name="txt6" value="6" style="display:none"><br/><br><br>
							</form>
