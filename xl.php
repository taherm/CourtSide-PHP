				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/cricket/maxresdefault.jpg">
									<div class="thumb-image"> <img src="images/cricket/maxresdefault.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/cricket/maxresdefault1.jpg">
									 <div class="thumb-image"> <img src="images/cricket/maxresdefault1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>15</span> m length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>2</span> m width</h5>
							</div>
							<div class="col-md-2 properties-detail">
						...
						<p>This is a 5-aside indoor cricket court.It has mat turf with nets around.Spikes can't be woren only trainers or sports shoes.It is located at Baglur in Bangalore..It cost 1000 per hour.It was started in the year 2012.The total area is 0.5 acres. </p>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<input type="text" name="txt0" value="XLR8" style="display:none">
						<input type="text" name="txt6" value="4" style="display:none"><br/><br>
								</form>
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.proxysitereviews.com/">proxy sites</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.151285,77.66883699999994),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.151285,77.66883699999994)});infowindow = new google.maps.InfoWindow({content:'<strong>XLR8</strong><br>baglur,bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
