		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/football/dsd.jpg">
									<div class="thumb-image"> <img src="images/football/dsd.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/football/dsd1.jpg">
									 <div class="thumb-image"> <img src="images/football/dsd1.jpg" data-imagezoom="true" class="img-responsive"> </div>
								
								<li data-thumb="images/football/xlr.png">
									   <div class="thumb-image"> <img src="images/football/xlr.png" data-imagezoom="true" class="img-responsive"> </div>
								</li>
							</ul>
						</div>
						<div class="clearfix"></div>
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>50</span> m length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>20</span> m width</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>5</span> aside</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>3</span> parking</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5>Washroom</h5>
							</div>
						...
						<p>This is a 5-aside football court located at TC Palya Bangalore.It has a well maintained european artificial turf..It cost 800 per hour.It was started in the year 2012.The total area is 0.2 acres.The owner of the soccer city is Suraj Tiru</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Football Nation" style="display:none">
								<input type="text" name="txt4" value="800" style="display:none">
							</form>
...
window.location="fn.php";
						...
						<input type="text" name="txt0" value="Football Nation" style="display:none">
						<input type="text" name="txt6" value="5" style="display:none">
						<input type="text" name="txt5" value="ss.php" style="display:none"><br><br>
						</form>
						</div>
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://freedirectorysubmissionsites.com/">link directories</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.0190631,77.70371309999996),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.0190631,77.70371309999996)});infowindow = new google.maps.InfoWindow({content:'<strong>Football Nation</strong><br>TC Palya,banglore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
							</div>
						</div>
						</div>
						...
						<div class="properties-top">
							<h4>Suraj Tiru</h4>
							<img src="images/tiru.jpg" class="img-responsive" alt=""/>
							<ul class="">
