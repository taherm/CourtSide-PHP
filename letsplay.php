...
<ul class="nav navbar-nav">
		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/football/WoodsidePark-SoccerFields.jpg">
									<div class="thumb-image"> <img src="images/football/WoodsidePark-SoccerFields.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/football/WoodsidePark-SoccerFields1.jpg">
									 <div class="thumb-image"> <img src="images/football/WoodsidePark-SoccerFields1.jpg" data-imagezoom="true" class="img-responsive"> </div>
								
								<li data-thumb="images/football/lets.jpg">
									   <div class="thumb-image"> <img src="images/football/lets.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
							</ul>
						</div>
						<div class="clearfix"></div>
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>100</span> m length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>50</span> m width</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>11</span> aside</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>4</span> parking</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5>Washroom</h5>
							</div>
						...
						<p>This is a 11-aside football court located at Ramamuthy nagar Bangalore.It has a well maintained european artificial turf..It cost 2500 per hour.It was started in the year 2012.The total area is 0.5 acres.The owner of the soccer city is Pranav Nair </p>
					
							<div class="contact-me">
							<h4>Book Court</h4>
							<form method="post" action="ssdb.php">
			...
			<tr>
					...
					<th width="600" height="50"><input type="email"name="txt2"style="width:500px;background-color:white"onblur="javascript:valemail(this.value)" ></th>
					</tr>
					<tr>
					<th width="600" height="50"><h3><center>Phone number</center></h3></th>
					<th width="600" height="50"><input type="text" name="txt3"  maxlength="10"style="width:500px;background-color:white" onblur="javascript:valphno(this.value)"></th>
					</tr>
					<tr>
					...
					<tr>	
								...
								<input type="text" name="txt6" value="3" style="display:none">
								<input type="text" name="txt0" value="Lets Play" style="display:none">
								<input type="text" name="txt4" value="2500" style="display:none">
							</form>
...
window.location="letsplay.php";
						...
						<input type="text" name="txt0" value="Lets Play" style="display:none">
						<input type="text" name="txt6" value="3" style="display:none">
						<input type="text" name="txt5" value="ss.php" style="display:none">
						</form>
						</div>
							<br><br>
						</div>
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.autohuren.world/">auto huren</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.0115177,77.67366900000002),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.0115177,77.67366900000002)});infowindow = new google.maps.InfoWindow({content:'<strong>Let\'s Play</strong><br>ramamurthy,banglore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
							</div>
						</div>
						</div>
						...
						<div class="properties-top">
							<h4>Pranav Nair</h4>
							<img src="images/pranav.jpg" class="img-responsive" alt=""/>
							<ul class="">
								<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i> Office : 080-25877654</li>
								<li><i class="glyphicon glyphicon-phone" aria-hidden="true"></i> Mobile : 8746536758</li>
