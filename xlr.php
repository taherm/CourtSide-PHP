		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/football/Turf-Field.jpg">
									<div class="thumb-image"> <img src="images/football/Turf-Field.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/football/Turf-Field1.jpg">
									 <div class="thumb-image"> <img src="images/football/Turf-Field1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>45</span> m length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>15</span> m width</h5>
							</div>
							<div class="col-md-2 properties-detail">
						...
						<p>This is a 5-aside football court located at Baglur Bangalore.It has a well maintained european artificial turf..It cost 1000 per hour.It was started in the year 2012.The total area is 0.2 acres.The owner of the soccer city is Vicky </p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt6" value="4" style="display:none">
								<input type="text" name="txt0" value="XLR8" style="display:none">
...
window.location="xlr.php";
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.proxysitereviews.com/">proxy sites</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.145434359508956,77.65574782000725),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.145434359508956,77.65574782000725)});infowindow = new google.maps.InfoWindow({content:'<strong>XLR8</strong><br>baglur,banglore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
							</div>
						</div>
						</div>
