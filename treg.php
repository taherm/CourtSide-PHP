...
$ven=$_POST['ven'];
?>
			<h1><b><center>Register for Tournaments</center></b></h1>
			
			<div class="contact-me" >
			<form action="regtour.php" method="post" enctype="multipart/form-data">
			...
			<td width="600" height="50"><center><input type="text" name="tnm" id="tm" style="width:500px;background-color:white"onfocus="theFocus()" value="<?php echo $tname;?>"readonly ></center></td>
			
			</tr>
			<tr>
			<th width="600" height="50"><h3><center><b>TEAM NAME</b></center></h3></th>
			...
			<td width="600" height="50"><center><input type="text" name="price"id="ef"style="width:500px;background-color:white"value="<?php echo $price;?>"readonly></center></td>
			</tr>
			<tr>
			<th width="600" height="50"><h3><center><b>Venue<b><center></h3></th>
			<td width="600" height="50"><center><input type="text" name="venue"id="ven" style="width:500px;background-color:white"value="<?php echo $ven;?>"readonly></center></td>
			</tr>
			<tr>
