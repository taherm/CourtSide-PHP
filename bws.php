		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/pools/1E.jpg">
									<div class="thumb-image"> <img src="images/pools/1E.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/pools/1E1.jpg">
									 <div class="thumb-image"> <img src="images/pools/1E1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a Outdoor pool.It ranges from 3 feet to 7 feet.It is located at Hebal Bangalore..It cost 400 per hour.It was started in the year 2012.</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="BWS" style="display:none">
								<input type="text" name="txt4" value="400" style="display:none">
								</form>
								<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://freedirectorysubmissionsites.com/">free web directories</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.037985387840935,77.5979663375732),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.037985387840935,77.5979663375732)});infowindow = new google.maps.InfoWindow({content:'<strong>BWS Club</strong><br>hebbal,bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
