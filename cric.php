		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/cricket/gfgf.jpg">
									<div class="thumb-image"> <img src="images/cricket/gfgf.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/cricket/gfgf1.jpg">
									 <div class="thumb-image"> <img src="images/cricket/gfgf1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a 5-aside cricket court.It is well maintained with artificial turf and central pitch.Spikes can't be woren only trainers or sports shoes.It is situated at Ramamurthy nagar Bangalore..It cost 1000 per hour.It was started in the year 2012.The total area is 0.5 acres. </p>
			...
			<tr>
					...
					<th width="600" height="50"><h3><center>Choose Slot</center></h3><br></th>
							...
							<select style="width:200px;height:30px;"name="slot">
					...
					<tr>	
								...
								<input type="text" name="txt0" value="CricZone" style="display:none">
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<input type="text" name="txt0" value="CricZone" style="display:none">
						<input type="text" name="txt6" value="3" style="display:none"><br/><br>
							</form>
