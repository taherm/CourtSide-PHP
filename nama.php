		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/football/nama.jpg">
									<div class="thumb-image"> <img src="images/football/nama.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/football/nama1.jpg">
									 <div class="thumb-image"> <img src="images/football/nama1.jpg" data-imagezoom="true" class="img-responsive"> </div>
								
								<li data-thumb="images/football/nam.jpg">
									   <div class="thumb-image"> <img src="images/football/nam.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
							</ul>
						</div>
						<div class="clearfix"></div>
						...
						<p>This is a 5-aside football court located at Airport Road Bangalore.It has a well maintained european artificial turf..It cost 1000 per hour.It was started in the year 2012.The total area is 0.2 acres.The owner of the soccer city is Rohit Ayyod</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt6" value="6" style="display:none">
								<input type="text" name="txt0" value="Nama Greens" style="display:none">
...
window.location="nama.php";
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.proxysitereviews.com/">proxy sites</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(12.9546284,77.6822522),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(12.9546284,77.6822522)});infowindow = new google.maps.InfoWindow({content:'<strong>Nama Greens</strong><br>Airport road,banglore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
							</div>
						</div>
						</div>
						...
						<div class="properties-top">
							<h4>Rohit Ayyod</h4>
							<img src="images/ayyod.jpg" class="img-responsive" alt=""/>
							<ul class="">
