		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/football/Soft-Surfaces-002.jpg">
									<div class="thumb-image"> <img src="images/football/Soft-Surfaces-002.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/football/Soft-Surfaces-003.jpg">
									 <div class="thumb-image"> <img src="images/football/Soft-Surfaces-003.jpg" data-imagezoom="true" class="img-responsive"> </div>
								
								<li data-thumb="images/football/ssturf.jpg">
									   <div class="thumb-image"> <img src="images/football/ssturf.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
							</ul>
						</div>
						<div class="clearfix"></div>
						...
						<p>This is a 11-aside football court located at Marathhalli Bangalore.It has a well maintained european artificial turf..It cost 2500 per hour.It was started in the year 2012.The total area is 0.5 acres.The owner of the soccer city is Vicky </p>
					
							<div class="contact-me">
							<h4>Book Court</h4>
							<form method="post" name="book" action="ssdb.php">
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="soccercity" style="display:none">
