		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/tennis/Tennis-Court11.jpg">
									<div class="thumb-image"><img src="images/tennis/Tennis-Court11.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/tennis/Tennis-Court111.jpg">
									 <div class="thumb-image"><img src="images/tennis/Tennis-Court111.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a Artficial turf court with well maintained artificial turf.It is located at Jainagar Bangalore...It cost 600 per hour.It was started in the year 2010.</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="UTF Academy" style="display:none">
								<input type="text" name="txt4" value="600" style="display:none"><br/>
								</form>
							<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.autohuren.world/">autohuren</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(12.910491,77.5857168),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(12.910491,77.5857168)});infowindow = new google.maps.InfoWindow({content:'<strong>UTF Academy</strong><br>jainagar,bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
