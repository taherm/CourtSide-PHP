		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/badminton/IMG_1121.jpg">
									<div class="thumb-image"> <img src="images/badminton/IMG_1121.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/badminton/IMG_11211.jpg">
									 <div class="thumb-image"> <img src="images/badminton/IMG_11211.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a Blue Synthetic court.It is well maintained artificial flooring.It is situated at Ramamurthy nagar Bangalore..It cost 700 per hour.It was started in the year 2012.. </p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Racket Arena" style="display:none">
								<input type="text" name="txt4" value="700" style="display:none">
								</form>
							<script>
