		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/cricket/11.jpg">
									<div class="thumb-image"> <img src="images/cricket/11.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/cricket/111.jpg">
									 <div class="thumb-image"> <img src="images/cricket/111.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>20</span> m length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>3</span> m width</h5>
							</div>
							<div class="col-md-2 properties-detail">
						...
						<p>This is a naturalturf ground.It is well maintained with practise nets.It is situated at Dumlur Bangalore..It cost 4000 per hour.It was started in the year 2012.The total area is 0.5 acres. </p>
					
							<div class="contact-me">
							<h4>Book Court</h4>
							<form method="post" action="cricdb.php">
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="BWSSY" style="display:none"><br/><br><br>
								<input type="text" name="txt4" value="4000" style="display:none"><br/><br><br><br>
								</form>
							<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<form method="post" action="criccan.php">
						...
						<input type="text" name="txt0" value="BWSSY" style="display:none">
						<input type="text" name="txt6" value="2" style="display:none"><br/><br>
							</form>
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.autohuren.world/">autohuren</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(12.955465136035736,77.65667021389162),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(12.955465136035736,77.65667021389162)});infowindow = new google.maps.InfoWindow({content:'<strong>BWSSY</strong><br>domlur, bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
