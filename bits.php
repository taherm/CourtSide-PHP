		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/pools/image.jpg">
									<div class="thumb-image"> <img src="images/pools/image.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/pools/image1.jpg">
									 <div class="thumb-image"> <img src="images/pools/image1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>40</span> ft length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>20</span> ft width</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>8</span> ft depth</h5>
							</div>
							<div class="col-md-2 properties-detail">
						...
						<p>This pool ranges from 3 feet to 8 feet .It is well maintained clean pool.It is situated at Henur Bangalore..It cost 300 per hour.It was started in the year 2012.</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Bits Club" style="display:none">
								<input type="text" name="txt4" value="300" style="display:none">
								</form>
								<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.autohuren.world/">autohuren</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.0345848,77.63686640000003),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.0345848,77.63686640000003)});infowindow = new google.maps.InfoWindow({content:'<strong>Bits Club</strong><br>hennur,bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
