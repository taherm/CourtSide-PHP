...
$sql="select * from cricket where bk_id='$bkid'";
...
<td width="300"height="70"><center><input type="text" name="cn" style="width:300px;background-color:lightblue;"value="<?php echo $crt;?>"  readonly></center></td>
</tr>
<tr>
<th width="300"height="70"><center>CUSTOMER NAME</center></th>
<td width="300"height="70"><center><input type="text" name="name"style="width:300px;background-color:lightblue;width:300;"value="<?php echo $name;?>"  readonly></center></td>
</tr>
<tr>
<th width="300"height="70"><center>PHONE NO</center></th>
<td width="300"height="70"><center><input type="text" name="ph" style="width:300px;background-color:lightblue;"value="<?php echo $phno;?>" readonly></center></td>
</tr>
<tr>
<th width="300"height="70"><center>EMAIL<center></th>
<td width="300"height="70"><center><input type="text" name="em"style="width:300px;background-color:lightblue;" value="<?php echo $em;?>"  readonly></center></td>
</tr>
<tr>
<th width="300"height="70"><center>SLOT</center></th>
<td width="300"height="70"><center><input type="text" name="sl" style="width:300px;background-color:lightblue;" value="<?php echo $slot;?>" readonly></center></td>
</tr>
<tr>
<th width="300"height="70"><center>BOOKING DATE</center></th>
<td width="300"height="70"><center><input type="text" name="bd"style="width:300px;background-color:lightblue;" value="<?php echo $bkd;?>"  readonly></center></td>
</tr>
<tr>
<th width="300"height="70"><center>PRICE</center></th>
<td width="300"height="70"><center><input type="text" name="pr" style="width:300px;background-color:lightblue;" value="<?php echo $price;?>" readonly></center></td>
</tr>
<tr>
<th width="300"height="70"><center>BOOKING ID</center></th>
<td width="300"height="70"><center><input type="text" name="id" style="width:300px;background-color:lightblue;" value="<?php echo $bkid;?>" readonly></center></td>
</tr>
<tr>


<td colspan="2"width="300"height="70"><a href="javascript:window.print()"><b><center> PRINT</center></b></a>
</tr>
</table>
<br>
<!---footer--->
