		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/basketball/hoops.jpg">
									<div class="thumb-image"><img src="images/basketball/hoops.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/basketball/hoops1.jpg">
									 <div class="thumb-image"><img src="images/basketball/hoops1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a indoor basketball court located at kothnur Bangalore.It has a well maintained artificial surface..It cost 1200 per hour.It was started in the year 2010.The owner of the soccer city is Karthik Naidu </p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Basketball Arena" style="display:none">
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<h3>View Routes</h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://freedirectorysubmissionsites.com/">free web directories</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.0551956,77.64222059999997),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.0551956,77.64222059999997)});infowindow = new google.maps.InfoWindow({content:'<strong>Basketball Arena</strong><br>kotnur,banglore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
