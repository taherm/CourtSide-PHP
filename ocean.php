		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/pools/swimming-pool.jpg">
									<div class="thumb-image"> <img src="images/pools/swimming-pool.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/pools/swimming-pool1.jpg">
									 <div class="thumb-image"> <img src="images/pools/swimming-pool1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<div class="properties-details">
							<div class="col-md-2 properties-detail">
								<h5><span>30</span> ft length</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>20</span> ft width</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>9</span> ft depth</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5><span>1</span> parking</h5>
							</div>
							<div class="col-md-2 properties-detail">
								<h5>Washroom</h5>
							</div>
						...
						<p>This is a Outdoor pool ranging from 3 feet to 9 feet.It is located at White Feild Bangalore..It cost 300 per hour.It was started in the year 2012.</p>
					
							<div class="contact-me">
							<h4>Book Pool</h4>
							<form method="post" action="swimdb.php">
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Ocean Club" style="display:none"><br/><br><br>
								<input type="text" name="txt4" value="300" style="display:none"><br/><br><br><br>
								</form>
								<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<form method="post" action="swimcan.php">
						...
						<input type="text" name="txt0" value="Ocean Club" style="display:none">
						<input type="text" name="txt6" value="6" style="display:none"><br/><br>
							</form>
						...
						<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://freedirectorysubmissionsites.com/">link directories</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(12.9697999,77.74994670000001),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(12.9697999,77.74994670000001)});infowindow = new google.maps.InfoWindow({content:'<strong>Ocean\'s Club</strong><br>White field,bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
