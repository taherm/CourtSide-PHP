		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/football/fc.jpg">
									<div class="thumb-image"> <img src="images/football/fc.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/football/fc1.jpg">
									 <div class="thumb-image"> <img src="images/football/fc1.jpg" data-imagezoom="true" class="img-responsive"> </div>
								
								<li data-thumb="images/football/kog.jpg">
									   <div class="thumb-image"> <img src="images/football/kog.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
							</ul>
						</div>
						<div class="clearfix"></div>
						...
						<p>This is a 11-aside football court located at Bellendur Bangalore.It has a well maintained european artificial turf..It cost 2000 per hour.It was started in the year 2012.The total area is 0.4 acres.The owner of the soccer city is Karthik Naidu </p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt6" value="2" style="display:none">
								<input type="text" name="txt0" value="Kicks on grass" style="display:none">
