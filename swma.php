		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/pools/435.jpg">
									<div class="thumb-image"> <img src="images/pools/435.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/pools/4351.jpg">
									 <div class="thumb-image"> <img src="images/pools/4351.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a Indoor pool.It ranges from 4 feet to 10 feet .It is located at Koramangla in Bangalore..It cost 400 per hour.It was started in the year 2012.</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Swimmers Arena" style="display:none"><br/><br><br>
								<input type="text" name="txt4" value="400" style="display:none"><br/><br><br><br>
								</form>
								<script>
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
						...
						<input type="text" name="txt0" value="Swimmers Arena" style="display:none">
