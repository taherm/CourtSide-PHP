		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/pools/gjhj.jpg">
									<div class="thumb-image"> <img src="images/pools/gjhj.jpg" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/pools/gjhj1.jpg">
									 <div class="thumb-image"> <img src="images/pools/gjhj1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a Outdoor pool ranging from 3 feet to 8 feet.It is located at MG Road Bangalore..It cost 400 per hour.It was started in the year 2012.</p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Dolphin Club" style="display:none">
								<input type="text" name="txt4" value="400" style="display:none"><br/>
								</form>
								<script>
