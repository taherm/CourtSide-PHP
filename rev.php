		...
		<div class="content">
				...
				<div class="properties-grids">
					<div class="col-md-9 properties-left">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/cricket/ritm3.png">
									<div class="thumb-image"> <img src="images/cricket/ritm3.png" data-imagezoom="true" class="img-responsive"> </div>
								</li>
								<li data-thumb="images/cricket/ritm31.png">
									 <div class="thumb-image"> <img src="images/cricket/ritm31.png" data-imagezoom="true" class="img-responsive"> </div>
						...
						<p>This is a clay ground with two pitches.It is located at Henur Bangalore...It cost 800 per hour.It was started in the year 2012.The total area is 0.5 acres. </p>
			...
			<tr>
					...
					<tr>	
								...
								<input type="text" name="txt0" value="Reva" style="display:none">
...
document.getElementById("ph").value = "";
 document.getElementById("ph").focus();
					...
					<h3><b>View Routes</b></h3>
								<script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:440px;width:700px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">									embed google maps							</a></small></div><div><small><a href="http://www.autohuren.world/">auto huren</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:10,center:new google.maps.LatLng(13.027058959061215,77.64235956406253),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(13.027058959061215,77.64235956406253)});infowindow = new google.maps.InfoWindow({content:'<strong>Reva Academy</strong><br>henur,bangalore,india<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
